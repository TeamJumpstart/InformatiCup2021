...
class CompositeCondition(Condition):
    ...
    def __init__(self, conditions, thresholds=None, logical_op=np.logical_and):
    ...
    def score(self, cells, player, opponents, rounds):
        ...
        for condition, threshold in zip(self.conditions, self.thresholds):
            score = self.logical_op(score, condition.score(cells, player, opponents, rounds) >= threshold)
